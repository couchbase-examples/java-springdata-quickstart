    ...
    public Docket api() {
        return new Docket(DocumentationType.OAS_30)
                ...
                .apis(RequestHandlerSelectors.basePackage(
                        "org.couchbase.quickstart.springdata.controllers"))
